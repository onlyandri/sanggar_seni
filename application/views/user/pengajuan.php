                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7">
                        ...
                        <form method="POST" action="<?php echo base_url('user/insert') ?>" class="form-group" enctype="multipart/form-data">
                            ...
                            <div class="mt-10">
                                <p>No Handphone</p>
                                <input type="number" name="hp" placeholder="masukan No Handphone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Ketua Sanggar'"
                                required class="single-input">
                            </div>
                            <div class="mt-10">
                                <p>Kategori</p>
                            ...
                            <div class="mt-10">
                                ...
                                <P>Alamat Lengkap</P>
                                <textarea type="text" name="alamat" placeholder="Masukan Alamat Lengkap Sanggar"
