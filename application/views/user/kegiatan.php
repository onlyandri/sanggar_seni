        ...
        <div class="navigation-top">
         ...
         <div class="navigation-area">
            <div class="row">
               ...
               <div class="thumb">
                  <a href="#">
                     <img class="img-fluid" src="<?php echo base_url('assets/pengguna/') ?>img/post/preview.png" alt="">
                  </a>
               </div>
               <div class="arrow">
                  <a href="#">
            ...
            <div class="thumb">
               <a href="#">
                  <img class="img-fluid" src="<?php echo base_url('assets/pengguna/') ?>img/post/next.png" alt="">
               </a>
            </div>
         </div>
      </div>
