  ...
  <div class="register-box">
   <div class="card bg-gradient-navy">
    <div class="card-body register-card-body bg-transparent">
      <h3 class="login-box-msg text-white font-weight-bold">Form Login</h3>
      ...
      <p class="mt-4">
        <a href="<?php echo base_url('') ?>" class="btn btn-block btn-danger">
         <i class="fas fa-logout"></i> Kembali ke Beranda
        </a>
      </p>
    </div>
    <!-- /.form-box -->
